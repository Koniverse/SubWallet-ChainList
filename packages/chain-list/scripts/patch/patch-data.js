import {readJSONFile, writeJSONFile} from "../utils/api.js";
import { md5HashChainAsset, md5HashChainInfo, PATCH_SAVE_DEV, PATCH_SAVE_DIR, PATCH_VERSION, STABLE_VERSION } from './patch-api.js';
import fs from "fs";
const CHAIN_PATH = './src/data/ChainInfo.json';
const ASSET_PATH = './src/data/ChainAsset.json';
