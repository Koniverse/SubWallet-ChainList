...
import { DATA_DIR, DOWNLOAD_DIR, DOWNLOAD_LINK, downloadFile, writeJSONFile } from '../utils/api.js';

const SAVE_PATH = `${DATA_DIR}/ChainAsset.json`;
const SAVE_REF_PATH = `${DATA_DIR}/AssetRef.json`;
