...
import MultiChainAsset from '../../src/data/MultiChainAsset.json' with { type: "json" };
import { DEFAULT_ICON, DOWNLOAD_LINK } from "../utils/api.js";

// Deprecated => It will auto update in vite config build process
