...
export declare const createCustomAccount: <A = string>(currency: string, currencyToAsset: (curr: string, api?: any) => A, accountDataType?: string) => (instanceId: string, api: ApiInterfaceRx) => RxResult<(arg: string | Uint8Array | AccountId) => Observable<AccountData>>;
